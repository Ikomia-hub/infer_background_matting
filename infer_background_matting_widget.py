...
from infer_background_matting.infer_background_matting_process import InferBckMattingParam
# PyQt GUI framework
...
# --------------------
class InferBckMattingWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferBckMattingParam()
        else:
...
# --------------------
class InferBckMattingWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "infer_background_matting"

    def create(self, param):
        # Create widget object
        return InferBckMattingWidget(param, None)
