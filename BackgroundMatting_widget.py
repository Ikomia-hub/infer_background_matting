...
# --------------------
class BackgroundMattingWidget(core.CProtocolTaskWidget):

    def __init__(self, param, parent):
        core.CProtocolTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = processMod.BackgroundMattingParam()
        else:
        ...
        self.model_backbone_scale.setMaximum(2.0)
        ...
        self.label_model_refine_mode = QLabel("model_backbone:")
        ...
        self.label_model_refine_threshold = QLabel("model_backbone_scale:")
        self.model_refine_threshold = QDoubleSpinBox()
        self.model_refine_threshold.setMinimum(0.0)
        self.model_refine_threshold.setMaximum(2.0)
        ...
        self.grid_layout.addWidget(self.label_model_refine_pixels, 6, 0)
